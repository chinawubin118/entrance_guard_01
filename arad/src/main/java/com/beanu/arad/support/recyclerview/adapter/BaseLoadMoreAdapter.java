...
public abstract class BaseLoadMoreAdapter<E, VH extends RecyclerView.ViewHolder> extends _BaseAdapter<E, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return viewType == VIEW_TYPE_LOADING ? new LoadMoreViewHolder(
                inflater.inflate(R.layout.arad_list_item_stream_status, parent, false)) : onCreateItemViewHolder(parent);
    }
